...
const CreateNewTenancy = ({ addOwnerasParty, setAddOwnerasParty }) => {
  const dispatch = useDispatch();

  const open = useSelector((state) => state.modal.openCreateNewTenancy);
  ...
  const handleClose = () => {
    dispatch(setCreateNewTenancyModal(false));
    // dispatch(setAddPropertyPartiesModal(true));
    setFormInitialValues();
  };
